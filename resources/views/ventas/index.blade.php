                        ...
                        <div class="col-md-4">
                            ...
                            <div class="product-image">
                                <a class="imagen-venta" href="product-detail.html">
                                    <img src="{{asset('$row->rutaFoto')}}" alt="Product Image">
                                </a>
                    ...
                    <div class="sidebar-widget widget-slider">
                        <div class="sidebar-slider normal-slider">
                            ...
                            <div class="product-image">
                                <a href="product-detail.html">
                                    <img class="imagen-venta" src="{{asset('img/carpa-venta.jpg')}}" alt="Product Image">
                                </a>
                                <div class="product-action">
                                    <a href="#"><i class="fa fa-cart-plus"></i></a>
                                    <a href="#"><i class="fa fa-heart"></i></a>
                        ...
                        <div class="product-item">
                            <div class="product-title">
                                ...
                                <div class="product-image">
                                    <a href="product-detail.html">
                                        <img class="imagen-venta" src="{{asset('img/carpa-grande.jpg')}}" alt="Product Image">
                                    </a>
                                    <div class="product-action">
                                        <a href="#"><i class="fa fa-cart-plus"></i></a>
                                        <a href="#"><i class="fa fa-heart"></i></a>
                            ...
                            <div class="product-item">
                                ...
                                <div class="product-image">
                                    <a href="product-detail.html">
                                        <img class="imagen-venta" src="{{asset('img/carpa-grande2.jpg')}}" alt="Product Image">
                                    </a>
                                    <div class="product-action">
                                        <a href="#"><i class="fa fa-cart-plus"></i></a>
                                        <a href="#"><i class="fa fa-heart"></i></a>
